...
public class LocalTestItem {
    ...
    public LocalTestItem(String identifier, String abnormalIndicator, String itemCode, Integer itemNO, String itemName, String referenceUnits, String referenceValue, String result, String units, String reportItemCode, String reportItemName, Timestamp resultDateTime) {
        this.identifier = identifier;
        this.abnormalIndicator = abnormalIndicator;
        this.itemCode = itemCode;
        this.itemNO = itemNO;
